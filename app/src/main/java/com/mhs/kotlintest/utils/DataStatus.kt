...
data class DataStatus<out T>(val status: Status, val data: T? = null, val message: String? = null) {
    ...
    /**
     * Companion object providing convenient factory methods for creating instances of com.mhs.kotlintest.utils.DataStatus.
     */
    companion object {
        /**
         * Creates a com.mhs.kotlintest.utils.DataStatus instance representing a loading state.
         */
        ...
        /**
         * Creates a com.mhs.kotlintest.utils.DataStatus instance representing a successful operation with the given data.
         *
        ...
        /**
         * Creates a com.mhs.kotlintest.utils.DataStatus instance representing an error state with the given error message.
         *
